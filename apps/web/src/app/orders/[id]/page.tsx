  ...
  return (
    <div className="max-w-[2560px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        {/* LEFT: Order Header + Timeline (takes 2/3) — slide-left animation */}
        <div className="lg:col-span-2">
          <ScrollReveal variant="slide-left">
            <div className="card p-6">
              ...
              {/* Vertical Timeline — each step fades in */}
              <div className="space-y-0">
                {statusSteps.map((step, i) => {
                  ...
                  return (
                    <ScrollReveal key={step} variant="fade" delay={i * 0.08}>
        ...
        {/* RIGHT: Sidebar — Items + Delivery Info — slide-right with stagger */}
        <div className="space-y-4">
          ...
          <ScrollReveal variant="pop" delay={0.3}>
            <div className="card p-5">
